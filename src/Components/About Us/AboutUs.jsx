    ...
    <div className="">
      ...
      <div className="grid md:grid-cols-2 gap-8 p-8  text-black mb-7 mx-5 rounded-xl">
        ...
        <div className="flex flex-col justify-center text-black wow animate__animated animate__backInRight">
          <div className="text-3xl font-bold text-red-500 mb-5">
            WHO WE ARE ?
          </div>
          <p className="mb-4 text-lg leading-relaxed wow animate__animated ">
            Welcome to Hidden Leaf Technologies, your innovative partner in the
            world of IT solutions. As a forward-thinking startup, we are
            dedicated to redefining the IT landscape with cutting-edge
            technology and a fresh perspective.
          </p>
          <p className="text-lg leading-relaxed">
            At Hidden Leaf Technologies, our mission is to empower businesses
            with state-of-the-art IT solutions that drive efficiency, foster
            growth, and unlock new opportunities. Our team of passionate tech
            experts combines deep industry knowledge with a commitment to
            excellence, providing tailored services that address the unique
      ...
      <div className="">
        ...
        <div className="mb-12  rounded-xl grid grid-cols-1 md:grid-cols-2">
          <div className="  content-center ml-10 md:ml-28 ">
            <p className=" text-3xl  font-bold text-red-500 mb-10 wow animate__animated animate__bounceInLeft  ">
              Our Core Beliefs
            </p>
            <p className=" text-xl   leading-relaxed  wow animate__animated animate__fadeInBottomRight">
              "Innovating the Future, One Solution at a Time, Empowering Your
              Vision with Cutting-Edge Technology, Transforming Ideas into
              Digital Success, Leading the Way in Tomorrow’s Technology Today."
            </p>
          </div>
              ...
              <div className="relative w-48 h-48 mb-4 group">
                ...
                <div className="absolute inset-0 flex justify-center items-center bg-white bg-opacity-60 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <div className="flex space-x-4">
                    <a
                      href="https://www.instagram.com/roshan_khapre?igsh=ZzNibmhtdHI2bmU2"
                      target="_blank"
                    ...
                    <a
                      href="https://www.linkedin.com/in/roshan-khapre-4a9266242?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="relative w-48 h-48 mb-4 group">
                ...
                <div className="absolute inset-0 flex justify-center items-center bg-white bg-opacity-60 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <div className="flex space-x-4">
                    <a
                      href="https://www.instagram.com/ayush.paradkar.1?igsh=MWd5cDhjeTQ2dWE3cQ=="
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Instagram className="text-gray-900 hover:text-red-500 transition-colors duration-200" />
                    ...
                    <a
                      href="https://www.linkedin.com/in/ayush-paradkar-b7685822a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <LinkedIn className="text-gray-900 hover:text-blue-500 transition-colors duration-200" />
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="relative w-48 h-48 mb-4 group">
                ...
                <div className="absolute inset-0 flex justify-center items-center bg-white bg-opacity-60 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <div className="flex space-x-4">
                    <a
                      href="https://www.instagram.com/shubham_kinkar_sk/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Instagram className="text-gray-900 hover:text-red-500 transition-colors duration-200" />
                    ...
                    <a
                      href="https://www.linkedin.com/in/shubham-kinkar/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <LinkedIn className="text-gray-900 hover:text-blue-500 transition-colors duration-200" />
              ...
              <div className="text-xl font-semibold">SHUBHAM KINKER</div>
